...
(function($) {
  ...
  ColorSelector.prototype = {
    ...
    _init : function() {
      ...
      var $markupSpan = $("<span>").addClass("btn-colorselector").css({ "background-color": selectColor, "background-image": 'url(' + selectValue + ')' });
      ...
      $("option", this.$select).each(function() {
        ...
        $markupA.css("background-image", 'url(' + value + ')');
      ...
      this.$select.on("change", function() {
        ...
        if (value.match("png$")) {          
            $(this).next().find(".btn-colorselector").css("background-image", 'url(' + value + ')');
        }
